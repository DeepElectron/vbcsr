#ifndef VBCSR_DETAIL_BACKEND_VENDOR_COMMON_HPP
#define VBCSR_DETAIL_BACKEND_VENDOR_COMMON_HPP
...
bool ensure_mkl_mm_variant_with_lru(
    MKLHandle& handle,
    int num_rhs,
    ...
    // Cache a small set of MKL MM handles by RHS width. Repeated batched
    // SpMM calls usually cycle through a few widths, so keeping the least
    // recently used policy here avoids bloating each CSR/BSR backend.
...
#endif // VBCSR_DETAIL_BACKEND_VENDOR_COMMON_HPP

...
SURFACE_MANIFEST: dict[str, SurfaceClass] = {
    ...
    "DistVector": SurfaceClass(
        ...
        symbols=(
            ...
            SurfaceSymbol("set_random", (), "DistVector::set_random", ('.def("set_random"',), ("set_random",), ("#### `set_random`",), ("tests/test_vbcsr.py",)),
    ...
    "DistMultiVector": SurfaceClass(
        ...
        symbols=(
            ...
            SurfaceSymbol("set_random", (), "DistMultiVector::set_random", ('.def("set_random"',), ("set_random",), ("#### `set_random`",), ("tests/test_wrapper_contracts.py",)),
